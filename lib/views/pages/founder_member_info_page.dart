...
import '../../controller/founder_committee_controller.dart';
import '../../model/founder_committee_model.dart';

class FounderMemberInfoPage extends StatefulWidget {
  const FounderMemberInfoPage({super.key});

  @override
  State<FounderMemberInfoPage> createState() => _FounderMemberInfoPageState();
}

class _FounderMemberInfoPageState extends State<FounderMemberInfoPage> {
  late Future<FounderCommitteeModel?> _futureCommittee;
  ...
  void initState() {
    super.initState();
    _futureCommittee = FounderCommitteeController.fetchCommitteeData();
  }
          ...
          children: [
            ...
            Expanded(
              child: Container(
                  ...
                  child: FutureBuilder<FounderCommitteeModel?>(
