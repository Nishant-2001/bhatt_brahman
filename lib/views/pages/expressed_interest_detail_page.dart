import 'package:bhatt_brahman_var_vadhu/model/expressed_interest_model.dart';
...
class ExpressedInterestDetailPage extends StatelessWidget {
  final ExpressedInterestModel item;
  const ExpressedInterestDetailPage({super.key, required this.item});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (item.requestStatus == 'Accept') ...[
                        ...
                        Text(""
                            "${item.firstName} ${item.lastName} profile has an ${item.matchPercentage} with yours."
                            )
                      ],
                      height(15),
                      Text(
                        ...
                        child: Padding(
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              buildRow("Birth Time :", item.birthTime ?? ""),
                              buildRow("Birth Place :", item.birthPlace ?? ""),
